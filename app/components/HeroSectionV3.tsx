        ...
        <section className="relative min-h-screen bg-gradient-to-br from-white via-navy-50 to-slate-purple-50 overflow-hidden max-w-screen-2xl mx-auto">
            ...
            <div className="fixed bottom-8 left-8 right-8 z-30 pointer-events-none">
                <div className="flex flex-col justify-end items-end space-y-3">
                    {/* AI Bot Indicator - New */}
                    <div className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-400 hover:to-purple-500 w-16 h-16 rounded-full flex items-center justify-center shadow-xl pointer-events-auto cursor-pointer hover:scale-110 transition-all duration-300 hover:shadow-2xl group relative overflow-hidden" onClick={handleWhatsAppContact}>
                    ...
                    {/* WhatsApp Bot Float - Enhanced Design */}
                    <div className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-400 hover:to-green-500 w-16 h-16 rounded-full flex items-center justify-center shadow-2xl pointer-events-auto cursor-pointer hover:scale-110 transition-all duration-300 hover:shadow-3xl group relative overflow-hidden" onClick={handleWhatsAppContact}>
                        {/* Background pattern for bot feel */}
                        <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

                        {/* Main WhatsApp icon */}
                        <svg className="w-8 h-8 text-white group-hover:scale-110 transition-transform duration-300 relative z-10" fill="currentColor" viewBox="0 0 24 24">
